...
<Header  />
      ...
      {/* section certificate */}
      <section className="bg-blue-800 pt-36 pb-32" id="certificate">
        <div className="container">
          <div className="w-full px-4">
            <div className="mx-auto mb-16 max-w-xl ">
              <h2 className="text-5xl lg:text-8xl font-bold text-white"> Certificate</h2>
              <h4 className="font-medium text-white lg:ml-5">Kompetisi || Seminar/Webinar || Beasiswa </h4>
            </div>
          </div>
          <div className="flex w-full flex-wrap justify-center px-4">
            ...
            <div className="mb-12 p-4 transition duration-300 ease-in-out hover:bg-teal-300 hover:shadow-lg md:w-1/2">
              <a href="https://drive.google.com/file/d/1l9LrasnyocTM883SPAYearXG-P-ScQ4w/view?usp=drive_link">
                <div className="overflow-hidden rounded-md shadow-md">
                  <img src="https://drive.google.com/uc?export=view&id=1l9LrasnyocTM883SPAYearXG-P-ScQ4w" alt="landing-coding" width="w-full" />
                </div>
              </a>
            </div>
            <div className="mb-12 p-4 transition duration-300 ease-in-out hover:bg-teal-300 hover:shadow-lg md:w-1/2">
            ...
            <a href="https://www.linkedin.com/in/aji-ramdani-ari-016bb1250">
              {" "}
              <h1 className="flex font-bold text-white hover:text-black">
                Lebih Banyak&nbsp; Linkedln
              </h1>
            </a>
          </div>
        </div>
      ...
      {/* section contact */}
      <section className="pt-36 pb-32 bg-gray-100" id="contact" >
        <div className="container">
          <div className="w-full px-4">
            <div className="mx-auto mb-8 max-w-xl text-center">
              <h4 className="font-semibold text-blue-500 "> Contact</h4>
              <h2  className="mb-4 text-3xl font-bold text-gradient-w1 sm:text-4xl lg:text-5xl">Hubungi Kami</h2>
          ...
          <form ref={form} onSubmit={sendEmail}>
            <div className="w-full lg:mx-auto lg:w-2/3">
              ...
              <div className="w-full px-4">
                <button type="submit" value="send" className="w-full rounded-full bg-blue-500 py-3 px-8 text-base font-semibold text-white transition duration-500 hover:opacity-80 hover:shadow-lg">
      ...
      <footer className="bg-white pt-24 pb-12">
        <div className="container">
          <div className="flex flex-wrap">
            <div className="mb-12 w-full px-4 font-medium text-black md:w-1/3">
            ...
            <div className="mb-12 w-full px-4 md:w-1/3">
              <h3 className="mb-5 text-xl font-semibold text-black">Kategori Skill</h3>
            ...
            <div className="mb-12 w-full px-4 md:w-1/3">
              <h3 className="mb-5 text-xl font-semibold text-black">Kategori Tautan</h3>
              <ul className="text-black">
                <li>
                  <a href="/" className="mb-3 inline-block text-base hover:text-blue-300">
                    Beranda
