...
const Media = () => {
    ...
    return(
       ...
       >
          <a href={ig} ><div className="bg-pink-500 w-60 h-10  rounded-lg flex justify-center items-center">
       <img src="https://www.svgrepo.com/show/452229/instagram-1.svg" width={30} />
        <h6 className="ml-3 font-bold text-white">Instagram</h6>
        </div></a>
        <a href={facebook} ><div className="bg-blue-500 w-60 h-10  rounded-lg flex justify-center items-center">
        ...
        <a href={github} ><div className="bg-gray-800 w-60 h-10  rounded-lg flex justify-center items-center">
        ...
        <a href={twitter} ><div className="bg-blue-300 w-60 h-10  rounded-lg flex justify-center items-center">
        ...
        <a href={youtube} ><div className="bg-red-400 w-60 h-10  rounded-lg flex justify-center items-center">
        ...
        <a href={linkedin} ><div className="bg-blue-900 w-60 h-10  rounded-lg flex justify-center items-center ">
        ...
        <a href={playstore} ><div className="bg-gray-300 w-60 h-10  rounded-lg flex justify-center items-center ">
        ...
        <a href={tiktok} ><div className="bg-pink-300 w-60 h-10  rounded-lg flex justify-center items-center ">
